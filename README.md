...
To build the final jar and optimize the ddRobot application for production, run:
...
Then navigate to [http://localhost:8329](http://localhost:8329) in your browser.
